    ...
    <section id="error-404" class="error-404 section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="text-center">
          ...
          <h2 class="error-title mb-3" data-aos="fade-up" data-aos-delay="400">Lo siento! Página no encontrada</h2>

          <p class="error-text mb-4" data-aos="fade-up" data-aos-delay="500">
            La página que estás buscando puede haber sido eliminada, cambiado su nombre o está temporalmente disponible.
          </p>
