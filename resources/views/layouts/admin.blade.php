        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="theme-toggle d-flex gap-2  align-items-center mt-2">
                ...
                <div class="form-check form-switch fs-6">
                    <input class="form-check-input  me-0" type="checkbox" data-bs-theme="dark" id="toggle-dark" style="cursor: pointer">
            ...
            <li
                ...
                <ul class="submenu ">
                    <li class="submenu-item  ">
                        <a href="#" class="submeu-link">Perfil</a>
                    </li>
                    <li class="submenu-item  ">
                        <a href="#" class="submeu-link">Seguridad</a>
                    </li>

                    <li class="submenu-item ">
                        <a href="{{ route('logout') }}" class="submenu-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Cerrar sesión</a>
