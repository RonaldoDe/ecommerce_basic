...
<body class="index-page">
    ...
    <div class="main-header">
      <div class="container-fluid container-xl">
        <div class="d-flex py-3 align-items-center justify-content-between">
          ...
          <!-- Search -->
          <form class="search-form desktop-search-form" action="{{ route('web.search') }}">
          ...
          <div class="header-actions d-flex align-items-center justify-content-end">
            ...
            <div class="dropdown account-dropdown">
              <button class="header-action-btn" data-bs-toggle="dropdown">
                <i class="bi bi-person"></i> {{ Auth::user()->name ?? 'Invitado' }}
              </button>
              <div class="dropdown-menu">
                <div class="dropdown-header">
                  <h6>Bienvenido a <span class="sitename">{{ $settings->name }}</span></h6>
                  <p class="mb-0">Acceso a tu cuenta &amp; gestionar tus pedidos</p>
                </div>
                ...
                <div class="dropdown-footer">
                  @if (Auth::check())
                    <form action="{{ route('logout') }}" method="post">
                      @csrf
                      <button type="submit" class="btn btn-primary w-100 mb-2">Cerrar sesión</button>
                    </form>
                  @else
                    <a href="{{ route('web.login') }}" class="btn btn-primary w-100 mb-2">Iniciar sesión</a>
  ...
  @if (Session::has('message') && Session::has('icon'))
    ...
    <script>
        ...
        let showConfirm = (status == 500 || status == 400);
